...
{    
    /// The states of the keyboard modifier keys.
    Key_State key_state = {
        .alt = false,
        .caps = false,
        .ctrl = false,
    ...
    /// Gets the character for a given key when shift is pressed.
    ...
    /// The key to get the shifted variant of.
    /// The shifted variant of the key.
